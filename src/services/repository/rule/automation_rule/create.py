...
"""Create automation_rule repository service module."""
...
from dtos import CreateAutomationRuleServiceDTO
...
class CreateAutomationRuleService(IAutomationRuleRepositoryService):
    """Application service for create operation on automation_rule repository."""
    ...
    async def run(self, request: CreateAutomationRuleServiceDTO) -> DTOLayer:
        """Executes create business logic for automation_rule."""
        ...
        try:
            ...
            return self.automation_rule_repository.create(model=automation_rule)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_AUTOMATION_RULE_SERVICE
