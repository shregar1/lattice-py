...
"""Create employment_config repository service module."""
...
from dtos import CreateEmploymentConfigInputDTO
...
class CreateEmploymentConfigService(IEmploymentConfigRepositoryService):
    """Application service for create operation on employment_config repository."""
    ...
    async def run(self, request: CreateEmploymentConfigInputDTO) -> DTOLayer:
        """Executes create business logic for employment_config."""
        ...
        try:
            ...
            return self.employment_config_repository.create(model=employment_config)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_EMPLOYMENT_CONFIG_SERVICE
