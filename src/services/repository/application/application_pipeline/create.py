...
"""Create application_pipeline repository service module."""
...
from dtos import CreateApplicationPipelineServiceDTO
...
class CreateApplicationPipelineService(IApplicationPipelineRepositoryService):
    """Application service for create operation on application_pipeline repository."""
    ...
    async def run(self, request: CreateApplicationPipelineServiceDTO) -> DTOLayer:
        """Executes create business logic for application_pipeline."""
        ...
        try:
            ...
            return self.application_pipeline_repository.create(model=application_pipeline)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_APPLICATION_PIPELINE_SERVICE
