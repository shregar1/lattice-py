...
"""Create portal_application repository service module."""
...
from dtos import CreatePortalApplicationServiceDTO
...
class CreatePortalApplicationService(IPortalApplicationRepositoryService):
    """Application service for create operation on portal_application repository."""
    ...
    async def run(self, request: CreatePortalApplicationServiceDTO) -> DTOLayer:
        """Executes create business logic for portal_application."""
        ...
        try:
            ...
            return self.portal_application_repository.create(model=portal_application)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_PORTAL_APPLICATION_SERVICE
