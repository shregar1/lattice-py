...
"""Delete portal_application repository service module."""
...
from dtos import DeletePortalApplicationServiceDTO
...
class DeletePortalApplicationService(IPortalApplicationRepositoryService):
    """Application service for delete operation on portal_application repository."""
    ...
    async def run(self, request: DeletePortalApplicationServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.portal_application_repository.hard_delete(id=request.id)
                return self.portal_application_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_PORTAL_APPLICATION_SERVICE
