...
"""Filter portal_application repository service module."""
...
from dtos import FilterPortalApplicationServiceDTO
...
class FilterPortalApplicationService(IPortalApplicationRepositoryService):
    """Application service for filter operation on portal_application repository."""
    ...
    async def run(self, request: FilterPortalApplicationServiceDTO) -> DTOLayer:
        """Executes filter business logic for portal_application."""
        ...
        try:
            return self.composite_portal_application_repository.filter_by_user_and_tenant(
    ...
    def name(self) -> str:
        ...
        return Service.FILTER_PORTAL_APPLICATION_SERVICE
