...
"""Update background_check repository service module."""
...
from dtos import UpdateBackgroundCheckServiceDTO
...
class UpdateBackgroundCheckService(IBackgroundCheckRepositoryService):
    """Application service for update operation on background_check repository."""
    ...
    async def run(self, request: UpdateBackgroundCheckServiceDTO) -> DTOLayer:
        """Executes update business logic for background_check."""
        ...
        try:
            ...
            return self.background_check_repository.update(model=background_check)
    ...
    def name(self) -> str:
        ...
        return Service.UPDATE_BACKGROUND_CHECK_SERVICE
