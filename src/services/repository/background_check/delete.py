...
"""Delete background_check repository service module."""
...
from dtos import DeleteBackgroundCheckServiceDTO
...
class DeleteBackgroundCheckService(IBackgroundCheckRepositoryService):
    """Application service for delete operation on background_check repository."""
    ...
    async def run(self, request: DeleteBackgroundCheckServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.background_check_repository.hard_delete(id=request.id)
                return self.background_check_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_BACKGROUND_CHECK_SERVICE
