...
"""Delete ai_screening_status_lk repository service module."""
...
from dtos import DeleteAiScreeningStatusLKServiceDTO
...
class DeleteAiScreeningStatusLKService(IAiScreeningStatusLKRepositoryService):
    """Application service for delete operation on ai_screening_status_lk repository."""
    ...
    async def run(self, request: DeleteAiScreeningStatusLKServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.ai_screening_status_lk_repository.hard_delete(id=request.id)
                return self.ai_screening_status_lk_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_AI_SCREENING_STATUS_LK_SERVICE
