...
"""Update ai_screening_status_lk repository service module."""
...
from dtos import UpdateAiScreeningStatusLKServiceDTO
...
class UpdateAiScreeningStatusLKService(IAiScreeningStatusLKRepositoryService):
    """Application service for update operation on ai_screening_status_lk repository."""
    ...
    async def run(self, request: UpdateAiScreeningStatusLKServiceDTO) -> DTOLayer:
        """Executes update business logic for ai_screening_status_lk."""
        ...
        try:
            ...
            return self.a_i_screening_status_lk_repository.update(model=ai_screening_status_lk)
    ...
    def name(self) -> str:
        ...
        return Service.UPDATE_AI_SCREENING_STATUS_LK_SERVICE
