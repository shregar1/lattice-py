...
"""Delete ai_screening_run repository service module."""
...
from dtos import DeleteAiScreeningRunServiceDTO
...
class DeleteAiScreeningRunService(IAiScreeningRunRepositoryService):
    """Application service for delete operation on ai_screening_run repository."""
    ...
    def __init__(
        ...
        ai_screening_run_repository: AIScreeningRunRepository = Dependency(AIScreeningRunRepositoryDependency),
        ...
        **kwargs: Any,
        ...
        self.ai_screening_run_repository = ai_screening_run_repository

    async def run(self, request: DeleteAiScreeningRunServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.ai_screening_run_repository.hard_delete(id=request.id)
                return self.ai_screening_run_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_AI_SCREENING_RUN_SERVICE
