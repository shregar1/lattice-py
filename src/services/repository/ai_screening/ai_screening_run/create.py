...
"""Create ai_screening_run repository service module."""
...
from dtos import CreateAiScreeningRunServiceDTO
...
class CreateAiScreeningRunService(IAiScreeningRunRepositoryService):
    """Application service for create operation on ai_screening_run repository."""
    ...
    async def run(self, request: CreateAiScreeningRunServiceDTO) -> DTOLayer:
        """Executes create business logic for ai_screening_run."""
        ...
        try:
            ...
            return self.a_i_screening_run_repository.create(model=ai_screening_run)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_AI_SCREENING_RUN_SERVICE
