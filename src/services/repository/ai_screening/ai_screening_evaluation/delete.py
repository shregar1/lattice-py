...
"""Delete ai_screening_evaluation repository service module."""
...
from dtos import DeleteAiScreeningEvaluationServiceDTO
...
class DeleteAiScreeningEvaluationService(IAiScreeningEvaluationRepositoryService):
    """Application service for delete operation on ai_screening_evaluation repository."""
    ...
    async def run(self, request: DeleteAiScreeningEvaluationServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.ai_screening_evaluation_repository.hard_delete(id=request.id)
                return self.ai_screening_evaluation_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_AI_SCREENING_EVALUATION_SERVICE
