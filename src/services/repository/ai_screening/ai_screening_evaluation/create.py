...
"""Create ai_screening_evaluation repository service module."""
...
from dtos import CreateAiScreeningEvaluationServiceDTO
...
class CreateAiScreeningEvaluationService(IAiScreeningEvaluationRepositoryService):
    """Application service for create operation on ai_screening_evaluation repository."""
    ...
    async def run(self, request: CreateAiScreeningEvaluationServiceDTO) -> DTOLayer:
        """Executes create business logic for ai_screening_evaluation."""
        ...
        try:
            ...
            return self.a_i_screening_evaluation_repository.create(model=ai_screening_evaluation)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_AI_SCREENING_EVALUATION_SERVICE
