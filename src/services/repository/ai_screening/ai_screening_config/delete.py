...
"""Delete ai_screening_config repository service module."""
...
from dtos import DeleteAiScreeningConfigServiceDTO
...
class DeleteAiScreeningConfigService(IAiScreeningConfigRepositoryService):
    """Application service for delete operation on ai_screening_config repository."""
    ...
    def __init__(
        ...
        ai_screening_config_repository: AIScreeningConfigRepository = Dependency(AIScreeningConfigRepositoryDependency),
        ...
        **kwargs: Any,
        ...
        self.ai_screening_config_repository = ai_screening_config_repository

    async def run(self, request: DeleteAiScreeningConfigServiceDTO) -> DTOLayer:
        ...
        try:
            ...
            if request.id:
                if request.is_hard_delete:
                    return self.ai_screening_config_repository.hard_delete(id=request.id)
                return self.ai_screening_config_repository.soft_delete(id=request.id)
            return request
    ...
    def name(self) -> str:
        ...
        return Service.DELETE_AI_SCREENING_CONFIG_SERVICE
