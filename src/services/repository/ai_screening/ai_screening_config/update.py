...
"""Update ai_screening_config repository service module."""
...
from dtos import UpdateAiScreeningConfigServiceDTO
...
class UpdateAiScreeningConfigService(IAiScreeningConfigRepositoryService):
    """Application service for update operation on ai_screening_config repository."""
    ...
    async def run(self, request: UpdateAiScreeningConfigServiceDTO) -> DTOLayer:
        """Executes update business logic for ai_screening_config."""
        ...
        try:
            ...
            return self.a_i_screening_config_repository.update(model=ai_screening_config)
    ...
    def name(self) -> str:
        ...
        return Service.UPDATE_AI_SCREENING_CONFIG_SERVICE
