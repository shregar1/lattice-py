...
"""Update offer repository service module."""
...
from dtos import UpdateOfferServiceDTO
...
class UpdateOfferService(IOfferRepositoryService):
    """Application service for update operation on offer repository."""
    ...
    async def run(self, request: UpdateOfferServiceDTO) -> DTOLayer:
        """Executes update business logic for offer."""
        ...
        try:
            ...
            return self.offer_repository.update(model=offer)
    ...
    def name(self) -> str:
        ...
        return Service.UPDATE_OFFER_SERVICE
