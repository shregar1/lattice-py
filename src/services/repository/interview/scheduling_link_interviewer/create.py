...
"""Create scheduling_link_interviewer repository service module."""
...
from dtos import CreateSchedulingLinkInterviewerServiceDTO
...
class CreateSchedulingLinkInterviewerService(ISchedulingLinkInterviewerRepositoryService):
    """Application service for create operation on scheduling_link_interviewer repository."""
    ...
    async def run(self, request: CreateSchedulingLinkInterviewerServiceDTO) -> DTOLayer:
        """Executes create business logic for scheduling_link_interviewer."""
        ...
        try:
            ...
            return self.scheduling_link_interviewer_repository.create(model=scheduling_link_interviewer)
    ...
    def name(self) -> str:
        ...
        return Service.CREATE_SCHEDULING_LINK_INTERVIEWER_SERVICE
