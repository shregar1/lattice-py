"""Request-timing utility dependency provider."""
...
class RequestTimingUtilityDependency(IRequestUtilityDependency):
    """
    Provides a configured :class:`RequestTimingUtility` bound to the request context.

    Attributes:
        component: Component name stamped on every log record.
    """

    component: str = "request_timing_utility"
    ...
    def resolve(
        ...
        **kwargs: Any,
        ...
        """
        Constructs a RequestTimingUtility bound to the request context.
        ...
        Args:
            ...
            **kwargs: Forwarded into RequestTimingUtility.


        returns:
            A RequestTimingUtility instance ready to record per-request spans.
        """
    ...
    def name(self) -> str:
        ...
        return UtilityDependency.REQUEST_TIMING
