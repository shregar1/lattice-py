"""Postgres utility dependency provider."""
...
from utilities import PostgresDatabaseUtility
from dependencies import LoggerUtilityDependency
from utilities import Logger


class PostgresDatabaseUtilityDependency(IDatabaseUtilityDependency):
    ...
    def name(self) -> str:
        ...
        return UtilityDependency.POSTGRES_DATABASE
