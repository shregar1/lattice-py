"""Outbox utility dependency provider."""
...
from utilities import OutboxUtility


class OutboxUtilityDependency(IUtilityDependency):
    """
    Provides a configured :class:`OutboxUtility` bound to the request context.
    ...
    def resolve(
        ...
        **kwargs: Any,
        ...
        """
        Constructs an OutboxUtility bound to the request context.
        ...
        Args:
            ...
            **kwargs: Forwarded into OutboxUtility.

        Returns:
            An OutboxUtility instance.
        """
        try:
            resolved_logger = logger
            return OutboxUtility(
                urn=urn,
    ...
    def name(self) -> str:
        ...
        return UtilityDependency.OUTBOX
