"""Display-name utility dependency provider."""
...
from utilities import DisplayNameUtility
from utilities import Logger


class DisplayNameUtilityDependency(IUtilityDependency):
    """
    Provides a configured :class:`DisplayNameUtility` bound to the request context.
    ...
    def resolve(
        ...
        **kwargs: Any,
        ...
        """
        Constructs a DisplayNameUtility bound to the request context.
        ...
        Args:
            ...
            **kwargs: Forwarded into DisplayNameUtility.


        returns:
            A DisplayNameUtility instance.
        """
        try:
            resolved_logger = logger
            return DisplayNameUtility(
                urn=urn,
    ...
    def name(self) -> str:
        ...
        return UtilityDependency.DISPLAY_NAME
