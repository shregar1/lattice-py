...
from .abstraction import INotificationConfigurationDependency
...
class SlackConfigurationDependency(INotificationConfigurationDependency):
    ...
    def resolve(
        ...
        config_path: str = SlackConfig.CONFIG_PATH,
        *args: Any,
        **kwargs: Any,
    ) -> SlackConfiguration:
    ...
    def name(self) -> str:
        ...
        return ConfigurationDependency.SLACK
