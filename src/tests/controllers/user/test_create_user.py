...
class TestCreateUser:
    ...
    @staticmethod
    def test_create_user_valid_payload(client):
        response = client.post(API_PATH, json={'email': 'user@example.com', 'name': 'Test User'})
    ...
    @staticmethod
    def test_create_user_response_is_json(client):
        response = client.post(API_PATH, json={'name': 'Some User'})
    ...
    @staticmethod
    def test_create_user_put_not_allowed(client):
        response = client.put(API_PATH, json={})
        assert response.status_code in (404, 405)

    @staticmethod
    def test_create_user_patch_not_allowed(client):
    ...
    def name(self) -> str:
        ...
        return "TestName.TestCreateUser"
