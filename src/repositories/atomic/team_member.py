"""Repository for TeamMember persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import TeamMemberDependency
...
class TeamMemberRepository(IAtomicRepository[TeamMember, int]):
    """Atomic repository for TeamMember."""
