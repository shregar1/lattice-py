"""Repository for ProjectTemplate persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import ProjectTemplateDependency
...
class ProjectTemplateRepository(IAtomicRepository[ProjectTemplate, int]):
    """Atomic repository for ProjectTemplate."""
    ...
    def exists_by_id_user_and_tenant(self, entity_id: int, user_id: int, tenant_id: int) -> bool:
        """Verifies record existence (parent-scoped IDOR handled in composite)."""
        return self.model.exists(id=entity_id)
