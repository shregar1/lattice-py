"""Repository for Project persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import ProjectDependency
...
class ProjectRepository(IAtomicRepository[Project, int]):
    """Atomic repository for Project."""
