"""Repository for User persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import UserDependency
...
class UserRepository(IAtomicRepository[User, int]):
    """Atomic repository for User."""
