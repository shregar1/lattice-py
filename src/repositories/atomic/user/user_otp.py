"""Repository for UserOtp persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import UserOtpDependency
...
class UserOtpRepository(IAtomicRepository[UserOtp, int]):
    """Atomic repository for UserOtp."""
