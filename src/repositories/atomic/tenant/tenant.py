"""Repository for Tenant persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import TenantDependency
...
class TenantRepository(IAtomicRepository[Tenant, int]):
    """Atomic repository for Tenant."""
