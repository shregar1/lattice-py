"""Repository for Contract persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import ContractDependency
...
class ContractRepository(IAtomicRepository[Contract, int]):
    """Atomic repository for Contract."""
