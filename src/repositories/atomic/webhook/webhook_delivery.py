"""Repository for WebhookDelivery persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import WebhookDeliveryDependency
...
class WebhookDeliveryRepository(IAtomicRepository[WebhookDelivery, int]):
    """Atomic repository for WebhookDelivery."""
