"""Repository for TemplateRole persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import TemplateRoleDependency
from dependencies.utility import LoggerUtilityDependency
from models import TemplateRole
from utilities import Logger

from ..abstraction import IAtomicRepository


class TemplateRoleRepository(IAtomicRepository[TemplateRole, int]):
    """Atomic repository for TemplateRole."""
