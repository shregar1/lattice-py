"""Repository for Template persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import TemplateDependency
...
class TemplateRepository(IAtomicRepository[Template, int]):
    """Atomic repository for Template."""
