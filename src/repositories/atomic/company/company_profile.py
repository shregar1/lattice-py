"""Repository for CompanyProfile persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import CompanyProfileDependency
...
class CompanyProfileRepository(IAtomicRepository[CompanyProfile, int]):
    """Atomic repository for CompanyProfile."""
