"""Repository for Company persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import CompanyDependency
...
class CompanyRepository(IAtomicRepository[Company, int]):
    """Atomic repository for Company."""
