"""Repository for InviteStatusLK persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import InviteStatusLKDependency
from dependencies.utility import LoggerUtilityDependency
from models import InviteStatusLK
from utilities import Logger

from .abstraction import ILookupRepository


class InviteStatusLKRepository(ILookupRepository[InviteStatusLK, int]):
    """Atomic repository for InviteStatusLK."""
