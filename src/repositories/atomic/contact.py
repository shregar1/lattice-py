"""Repository for Contact persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import ContactDependency
...
class ContactRepository(IAtomicRepository[Contact, int]):
    """Atomic repository for Contact."""
