"""Repository for AuditEvent persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import AuditEventDependency
...
class AuditEventRepository(IAtomicRepository[AuditEvent, int]):
    """Atomic repository for AuditEvent."""
