"""Repository for Field persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import FieldDependency
...
class FieldRepository(IAtomicRepository[Field, int]):
    """Atomic repository for Field."""
