"""Repository for Envelope persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import EnvelopeDependency
...
class EnvelopeRepository(IAtomicRepository[Envelope, int]):
    """Atomic repository for Envelope."""
