"""Repository for ExportRecord persistence and domain queries."""

from typing import Any, Optional

from rivex import Dependency

from dependencies.model import ExportDependency
...
class ExportRepository(IAtomicRepository[ExportRecord, int]):
    """Atomic repository for ExportRecord."""
