"""Repository implementation for UserTypeLK."""
...
from models import Tenant, User, UserTypeLK
from repositories.atomic import UserTypeLKRepository as AtomicUserTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class UserTypeLKRepository(AtomicUserTypeLKRepository, ICompositeRepository):
    """Repository for UserTypeLK; extends AtomicUserTypeLKRepository."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        AtomicUserTypeLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[UserTypeLK]:
        """Filter UserTypeLK records by code."""
        start_time = time.time()
