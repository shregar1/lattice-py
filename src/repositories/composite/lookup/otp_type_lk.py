"""Repository implementation for OtpTypeLK."""
...
from models import OtpTypeLK, Tenant, User
from repositories.atomic import OtpTypeLKRepository as AtomicOtpTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class OtpTypeLKRepository(AtomicOtpTypeLKRepository, ICompositeRepository):
    """Repository for OtpTypeLK; extends AtomicOtpTypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[OtpTypeLK]:
        """Filter OtpTypeLK records by code."""
        start_time = time.time()
