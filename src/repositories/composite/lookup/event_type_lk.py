"""Repository implementation for EventTypeLK."""
...
from models import EventTypeLK, Tenant, User
from repositories.atomic import EventTypeLKRepository as AtomicEventTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class EventTypeLKRepository(AtomicEventTypeLKRepository, ICompositeRepository):
    """Repository for EventTypeLK; extends AtomicEventTypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[EventTypeLK]:
        """Filter EventTypeLK records by code."""
        start_time = time.time()
