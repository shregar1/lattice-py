"""Repository implementation for MFATypeLK."""
...
from models import MFATypeLK, Tenant, User
from repositories.atomic import MFATypeLKRepository as AtomicMFATypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class MFATypeLKRepository(AtomicMFATypeLKRepository, ICompositeRepository):
    """Repository for MFATypeLK; extends AtomicMFATypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[MFATypeLK]:
        """Filter MFATypeLK records by code."""
        start_time = time.time()
