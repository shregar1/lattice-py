"""Repository implementation for AuthTypeLK."""
...
from models import AuthTypeLK, Tenant, User
from repositories.atomic import AuthTypeLKRepository as AtomicAuthTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class AuthTypeLKRepository(AtomicAuthTypeLKRepository, ICompositeRepository):
    """Repository for AuthTypeLK; extends AtomicAuthTypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[AuthTypeLK]:
        """Filter AuthTypeLK records by code."""
        start_time = time.time()
