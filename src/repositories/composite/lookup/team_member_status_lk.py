"""Repository implementation for TeamMemberStatusLK."""
...
from models import TeamMemberStatusLK, Tenant, User
from repositories.atomic import TeamMemberStatusLKRepository as AtomicTeamMemberStatusLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class TeamMemberStatusLKRepository(AtomicTeamMemberStatusLKRepository, ICompositeRepository):
    """Repository for TeamMemberStatusLK; extends AtomicTeamMemberStatusLKRepository."""
    ...
    def __init__(
        ...
        model: type[TeamMemberStatusLK] = Dependency(TeamMemberStatusLKDependency),
        tenant_model: type[Tenant] = Dependency(TenantDependency),
        user_model: type[User] = Dependency(UserDependency),
        *args: Any,
        **kwargs: Any,
    ) -> None:
        AtomicTeamMemberStatusLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[TeamMemberStatusLK]:
        """Filter TeamMemberStatusLK records by code."""
        start_time = time.time()
    ...
    def name(self) -> str:
        ...
        return "TeamMemberStatusLKRepository"
