"""Repository implementation for WebhookDeliveryStatusLK."""
...
from models import Tenant, User, WebhookDeliveryStatusLK
from repositories.atomic import WebhookDeliveryStatusLKRepository as AtomicWebhookDeliveryStatusLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class WebhookDeliveryStatusLKRepository(AtomicWebhookDeliveryStatusLKRepository, ICompositeRepository):
    """Repository for WebhookDeliveryStatusLK; extends AtomicWebhookDeliveryStatusLKRepository."""
    ...
    def __init__(
        ...
        model: type[WebhookDeliveryStatusLK] = Dependency(WebhookDeliveryStatusLKDependency),
        tenant_model: type[Tenant] = Dependency(TenantDependency),
        user_model: type[User] = Dependency(UserDependency),
        *args: Any,
        **kwargs: Any,
    ) -> None:
        AtomicWebhookDeliveryStatusLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[WebhookDeliveryStatusLK]:
        """Filter WebhookDeliveryStatusLK records by code."""
        start_time = time.time()
    ...
    def name(self) -> str:
        ...
        return "WebhookDeliveryStatusLKRepository"
