"""Repository implementation for EnvelopeStatusLK."""
...
from models import EnvelopeStatusLK, Tenant, User
from repositories.atomic import EnvelopeStatusLKRepository as AtomicEnvelopeStatusLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class EnvelopeStatusLKRepository(AtomicEnvelopeStatusLKRepository, ICompositeRepository):
    """Repository for EnvelopeStatusLK; extends AtomicEnvelopeStatusLKRepository."""
    ...
    def __init__(
        ...
        model: type[EnvelopeStatusLK] = Dependency(EnvelopeStatusLKDependency),
        tenant_model: type[Tenant] = Dependency(TenantDependency),
        user_model: type[User] = Dependency(UserDependency),
        *args: Any,
        **kwargs: Any,
    ) -> None:
        AtomicEnvelopeStatusLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[EnvelopeStatusLK]:
        """Filter EnvelopeStatusLK records by code."""
        start_time = time.time()
    ...
    def name(self) -> str:
        ...
        return "EnvelopeStatusLKRepository"
