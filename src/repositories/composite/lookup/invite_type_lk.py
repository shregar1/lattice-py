"""Repository implementation for InviteTypeLK."""
...
from models import InviteTypeLK, Tenant, User
from repositories.atomic import InviteTypeLKRepository as AtomicInviteTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class InviteTypeLKRepository(AtomicInviteTypeLKRepository, ICompositeRepository):
    """Repository for InviteTypeLK; extends AtomicInviteTypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[InviteTypeLK]:
        """Filter InviteTypeLK records by code."""
        start_time = time.time()
