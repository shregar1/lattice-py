"""Repository implementation for RecipientStatusLK."""
...
from models import RecipientStatusLK, Tenant, User
from repositories.atomic import RecipientStatusLKRepository as AtomicRecipientStatusLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class RecipientStatusLKRepository(AtomicRecipientStatusLKRepository, ICompositeRepository):
    """Repository for RecipientStatusLK; extends AtomicRecipientStatusLKRepository."""
    ...
    def __init__(
        ...
        model: type[RecipientStatusLK] = Dependency(RecipientStatusLKDependency),
        tenant_model: type[Tenant] = Dependency(TenantDependency),
        user_model: type[User] = Dependency(UserDependency),
        *args: Any,
        **kwargs: Any,
    ) -> None:
        AtomicRecipientStatusLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[RecipientStatusLK]:
        """Filter RecipientStatusLK records by code."""
        start_time = time.time()
    ...
    def name(self) -> str:
        ...
        return "RecipientStatusLKRepository"
