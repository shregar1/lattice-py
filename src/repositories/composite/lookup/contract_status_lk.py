"""Repository implementation for ContractStatusLK."""
...
from models import ContractStatusLK, Tenant, User
from repositories.atomic import ContractStatusLKRepository as AtomicContractStatusLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class ContractStatusLKRepository(AtomicContractStatusLKRepository, ICompositeRepository):
    """Repository for ContractStatusLK; extends AtomicContractStatusLKRepository."""
    ...
    def __init__(
        ...
        model: type[ContractStatusLK] = Dependency(ContractStatusLKDependency),
        tenant_model: type[Tenant] = Dependency(TenantDependency),
        user_model: type[User] = Dependency(UserDependency),
        *args: Any,
        **kwargs: Any,
    ) -> None:
        AtomicContractStatusLKRepository.__init__(
            self,
            urn=urn,
            tenant_id=tenant_id,
    ...
    def filter_by_code(self, code: str) -> List[ContractStatusLK]:
        """Filter ContractStatusLK records by code."""
        start_time = time.time()
    ...
    def name(self) -> str:
        ...
        return "ContractStatusLKRepository"
