"""Repository implementation for MimeTypeLK."""
...
from models import MimeTypeLK, Tenant, User
from repositories.atomic import MimeTypeLKRepository as AtomicMimeTypeLKRepository
from utilities import Logger

from ..abstraction import ICompositeRepository


class MimeTypeLKRepository(AtomicMimeTypeLKRepository, ICompositeRepository):
    """Repository for MimeTypeLK; extends AtomicMimeTypeLKRepository."""
    ...
    def filter_by_code(self, code: str) -> List[MimeTypeLK]:
        """Filter MimeTypeLK records by code."""
        start_time = time.time()
